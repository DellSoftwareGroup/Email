...
<p>The days of having to choose between supporting Outlook or retina devices are over. To use high resolution images, put
	<code>height</code> and <code>width</code> HTML attributes on the
	<kbd>&lt;img&gt;</kbd> tag, corresponding to the scaled size of the image in a desktop view (the width of its
	<code>.columns</code> container). On small screen devices, Ink will cause the image to expand to its full width (or the width or its parent element, whichever is smaller).
</p>
<h6>Image Markup</h6>
<?php code_example(
...
<p>Below is a chart of the sizes images should be to fully fit various sizes of grid columns on a desktop (larger than 600px) view. Height should be determined with respect to width and should also be explicitly declared on the
	<kbd>&lt;img&gt;</kbd> tag.</p>
<table>
	<thead>
...
<div class="compatibility-section">
	<div class="row">
		<div class="large-9 columns">
			<p>Retina images work as expected in most major email clients, with some caveats in
		...
		<div class="small-12 columns">
			<table>
				...
				<tr>
					...
					<td>Since the inline sizing will not be overwritten in mobile Gmail, retina images should not be used with
						<a href="#gmail">block-grid</a> based layouts (they're fine with the <a href="#grid">standard grid</a>.
					</td>
				</tr>
				<tr>
